...
class ProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "show" do
    ...
    data = JSON.parse(response.body)
    assert_equal ["id", "name", "price", "image_url", "description", "is_discounted?", "tax", "total", "quantity", "supplier", created_at", "updated_at"], data.keys
  end
  ...
  test "update" do
    ...
    patch "/products/#{product.id}.json", params: { price: 0 }
    assert_response 422
  end
